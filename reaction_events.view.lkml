view: reaction_events {
  sql_table_name: zeitgeist.reaction_events ;;
  ...
  dimension: properties__reaction_id {
    type: string
    sql: ${TABLE}.properties.reaction_id ;;
  }

  dimension: properties__type {
    type: string
    sql: ${TABLE}.properties.type ;;
  }

  dimension: properties__variant_id {
    type: string
    sql: ${TABLE}.properties.variant_id ;;
  }

view: brandliftresponse_events {
  sql_table_name: zeitgeist.brandliftresponse_events ;;
  ...
  dimension: properties__campaign {
    type: string
    sql: ${TABLE}.properties.campaign ;;
  }
  ...
  dimension: properties__question {
    type: string
    sql: ${TABLE}.properties.question ;;
  }

  dimension: properties__response {
    type: string
    sql: ${TABLE}.properties.response ;;
  }
